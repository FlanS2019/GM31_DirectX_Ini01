...
void Tree::Init()
{
	...
	vertex[0].Normal = XMFLOAT3(0, 0, -1);
	...
	vertex[2].Position = XMFLOAT3(1, 0, 0);
	vertex[2].Normal = XMFLOAT3(0, 0, -1);
	vertex[2].Diffuse = XMFLOAT4(1, 1, 1, 1);
	vertex[2].TexCoord = XMFLOAT2(0, 10);

	vertex[3].Position = XMFLOAT3(1, 0, 0);
	vertex[3].Normal = XMFLOAT3(0, 0, -1);
...
void Tree::Draw()
{
	...
	invView.r[3].m128_f32[0] = 0;//平行移動成分をリセット
